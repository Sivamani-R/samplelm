...
export const ManagerApprovalHistoryPage = () => {
  ...
  const loadHistory = async () => {
    try {
      ...
      setError(err.message || 'Unable to fetch manager approval history.');
    } finally {
      setIsLoading(false);
    }
  };
  ...
  return (
    <div>
      <PageHeader
        ...
        subtitle="Audited log of executive approvals, rejections, and escalations"
        breadcrumbs={[
      ...
      {isLoading ? (
        <LoadingSpinner text="Fetching manager decision log..." />
      ) : error ? (
